import { findLesson, findPath } from "./config/paths.js?v=20260829-24";
import { navigateToHash, startRouter } from "./router.js?v=20260829-24";
import { element, pageHeader } from "./ui/components.js?v=20260829-24";
import { renderHomeView } from "./views/home-view.js?v=20260829-24";
import { renderPathView } from "./views/path-view.js?v=20260829-24";
import { renderPathsView } from "./views/paths-view.js?v=20260829-24";
import { renderLessonView } from "./views/lesson-view.js?v=20260829-24";
import { renderProgressView } from "./views/progress-view.js?v=20260829-24";
import { renderSearchView } from "./views/search-view.js?v=20260829-24";
import { renderReviewView } from "./views/review-view.js?v=20260829-24";
import { renderAssessmentView } from "./views/assessment-view.js?v=20260829-24";
import { renderPathAssessmentView } from "./views/path-assessment-view.js?v=20260829-24";
import { createPreferencesStore } from "./study/preferences.js?v=20260829-24";
import { shouldPreserveCinematicScroll } from "./home/home-shared-transition.js?v=20260829-24";
