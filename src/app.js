...
import { renderProgressView } from "./views/progress-view.js?v=20260828-15";
import { renderSearchView } from "./views/search-view.js?v=20260828-15";
import { renderReviewView } from "./views/review-view.js?v=20260828-15";
import { renderAssessmentView } from "./views/assessment-view.js?v=20260828-15";
import { renderPathAssessmentView } from "./views/path-assessment-view.js?v=20260828-15";
