    ...
    for (let i = 0, j = 0; i < positions.length; i += 3, j += 2) {
      ...
      switch (side) {
        case 0:
          ...
          uvs[j] = getUv(faceDirVector, normal, 'z', 'y', radius, depth);
          uvs[j + 1] = 1 - getUv(faceDirVector, normal, 'y', 'z', radius, height);
          break;
        case 1:
          faceDirVector.set(-1, 0, 0);
          uvs[j] = 1 - getUv(faceDirVector, normal, 'z', 'y', radius, depth);
          uvs[j + 1] = 1 - getUv(faceDirVector, normal, 'y', 'z', radius, height);
          break;
        case 2:
          faceDirVector.set(0, 1, 0);
          uvs[j] = 1 - getUv(faceDirVector, normal, 'x', 'z', radius, width);
        ...
        case 4:
          ...
          uvs[j] = 1 - getUv(faceDirVector, normal, 'x', 'y', radius, width);
          uvs[j + 1] = 1 - getUv(faceDirVector, normal, 'y', 'x', radius, height);
          break;
        case 5:
          faceDirVector.set(0, 0, -1);
          uvs[j] = getUv(faceDirVector, normal, 'x', 'y', radius, width);
          uvs[j + 1] = 1 - getUv(faceDirVector, normal, 'y', 'x', radius, height);
          break;
      }
    }
